...
class DetectGPTModel:
    def __init__(
        ...
        self.gpt2_tokenizer = transformers.GPT2Tokenizer.from_pretrained(
            base_model_name
            # "gpt2",
        ...
        self.base_tokenizer = transformers.AutoTokenizer.from_pretrained(self.base_model_name,
                                                                         # cache_dir=self.cache_dir
                                                                         )
...
class DetectGPT:
    def __init__(self, base_model_name: str = "gpt2-medium", mask_filling_model_name: str = "t5-large"):
        self.detect_gpt_instance = DetectGPTModel(
            pct_words_masked=0.15, n_perturbation_list="10",
